  ...
  return (
    <article
      className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[250px] md:w-[300px]
                  xl:w-[450px] snap-center bg-[#2e3643] p-5 hover:opacity-100 opacity-40 cursor-pointer
    ...
    >
      ...
      <div className="px-0 md:px-5 items-start">
        ...
        <ul className="list-disc space-y-2 text-xs h-60 px-4 overflow-y-auto scrollbar-thin scrollbar-track-black scrollbar-thumb-[@F7AB0A]/80">
